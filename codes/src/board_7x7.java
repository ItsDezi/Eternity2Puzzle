...
public class board_7x7 {

		private Piece[][] b = new Piece[9][9];//board will be surrounded by "artificial" edge pieces
		private Piece[] all_pieces = new Piece[49];
		int number_of_rows = 7;//number of real pieces(not artificial edge ones)
		int n = 7;//since its always an nXn grid, I just added this to simplify things
		int number_of_columns = 7;//number of real pieces(not artificial edge ones)
		int pieceID = 0;
		Stack<Piece> stack = new Stack<Piece>();//backbone of the backtracking
		int[][] stack_height = new int[7][7];
		...
		public board_7x7(String fileName)
		{
			int count = 0;
	        	...
	        	while(row < b.length-1) {
	        		...
	        		while(col<b.length-1)
	        		{
	        			...
	        			Piece bottom = b[row+1][col];
        					...
        					compare_subarrays(lefty, toppy, righty, bottom);
		...
		public static void main(String[] args) {
			...
			board_7x7 bb = new board_7x7("sides_7x7.txt");
