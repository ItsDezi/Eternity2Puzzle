...
public class board_6x6 {
		...
		private Piece[][] b = new Piece[8][8];//board will be surrounded by "artificial" edge pieces
		private Piece[] all_pieces = new Piece[36];
		int number_of_rows = 6;//number of real pieces(not artificial edge ones)
		int n = 6;//since its always an nXn grid, I just added this to simplify things
		int number_of_columns = 6;//number of real pieces(not artificial edge ones)
		int pieceID = 0;
		Stack<Piece> stack = new Stack<Piece>();//backbone of the backtracking
		int[][] stack_height = new int[6][6];
		...
		public board_6x6(String fileName)
		{
			int count = 0;
		...
		public static void main(String[] args) {
			...
			board_6x6 bb = new board_6x6("sides_6x6.txt");
