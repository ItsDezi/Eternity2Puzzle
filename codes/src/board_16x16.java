...
public class board_16x16 {

		private Piece[][] b = new Piece[18][18];//board will be surrounded by "artificial" edge pieces
		private Piece[] all_pieces = new Piece[256];
		int number_of_rows = 16;//number of real pieces(not artificial edge ones)
		int n = 16;//since its always an nXn grid, I just added this to simplify things
		int number_of_columns = 16;//number of real pieces(not artificial edge ones)
		int pieceID = 0;
		Stack<Piece> stack = new Stack<Piece>();//backbone of the backtracking
		int[][] stack_height = new int[16][16];
		...
		Piece[] arr13 = new Piece[24];//all pieces with a side of value 13
		Piece[] arr14 = new Piece[24];//all pieces with a side of value 14
		...
		public board_16x16(String fileName)
		{
			int count = 0;
			Scanner ss;
		...
		public static void main(String[] args) {
			...
			board_16x16 bb = new board_16x16("sides_16x16.txt");
