...
public class board_4x4 {

		private Piece[][] b = new Piece[6][6];//board will be surrounded by "artificial" edge pieces
		private Piece[] all_pieces = new Piece[16];
		int number_of_rows = 4;//number of real pieces(not artificial edge ones)
		int n = 4;//since its always an nXn grid, I just added this to simplify things
		int number_of_columns = 4;//number of real pieces(not artificial edge ones)
		int pieceID = 0;
		Stack<Piece> stack = new Stack<Piece>();//backbone of the backtracking
		int[][] stack_height = new int[4][4];
		//15 different pieces in the 10X10
		int row = 1;//W.R.T board b
		int col = 1;//W.R.T board b
		
		Piece[] arr0 = new Piece[30];//all pieces with a side of value 0
		...
		public board_4x4(String fileName)
		{
			int count = 0;
		...
		public static void main(String[] args) {
			...
			board_4x4 bb = new board_4x4("sides_4x4.txt");
